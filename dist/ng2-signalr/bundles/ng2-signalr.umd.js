(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('signalr-no-jquery')) :
    typeof define === 'function' && define.amd ? define('ng2-signalr', ['exports', 'rxjs', '@angular/core', 'signalr-no-jquery'], factory) :
    (global = global || self, factory(global['ng2-signalr'] = {}, global.rxjs, global.ng.core, global.signalrNoJquery));
}(this, function (exports, rxjs, core, signalrNoJquery) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var SIGNALR_JCONNECTION_TOKEN = new core.InjectionToken('SIGNALR_JCONNECTION_TOKEN');
    ...
    var SignalR = /** @class */ (function () {
        ...
        SignalR.ctorParameters = function () { return [
            ...
            { type: core.NgZone },
            { type: undefined, decorators: [{ type: core.Inject, args: [SIGNALR_JCONNECTION_TOKEN,] }] }
        ]; };
        return SignalR;
    }());
    ...
    function getJConnectionFn() {
        /** @type {?} */
        var hubConnectionFn = signalrNoJquery.hubConnection;
    ...
    exports.ɵa = createSignalr;
    exports.ɵb = SIGNALR_JCONNECTION_TOKEN;
